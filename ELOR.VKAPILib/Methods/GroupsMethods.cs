...
namespace ELOR.VKAPILib.Methods {
    public class GroupsMethods : MethodsSectionBase {
        ...
        public async Task<GroupsList> GetAsync(long userId, List<string> fields = null, List<string> filter = null, int offset = 0, int count = 1000) {
            ...
            return await API.CallMethodAsync<GroupsList>("groups.get", parameters);
        }
